...
// создание функции расскладывающая любую строку в массив символов
// принимает слово и приравнивает его к типу Character
...
func checkSmallWord(checkingWord: String) -> Bool {
...
//вывод функции
checkSmallWord(checkingWord: "мантия")

checkSmallWord(checkingWord: "Партия")
